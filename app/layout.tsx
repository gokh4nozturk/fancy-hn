...
export const metadata: Metadata = {
  ...
  description: "Experience Hacker News with a modern and user-friendly interface. Latest technology news, discussions, and content.",
  keywords: ["hacker news", "technology", "software", "programming", "startup", "entrepreneurship"],
  ...
  twitter: {
    ...
    title: "Fancy Hacker News",
    description: "Experience Hacker News with a modern and user-friendly interface",
